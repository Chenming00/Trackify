...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 font-sans">
      <div className="pt-10 px-4 sm:px-6 max-w-2xl mx-auto space-y-6">
        ...
        {/* Total Value Card */}
        <div className="bg-gradient-to-br from-emerald-400 to-green-600 rounded-[1.75rem] p-6 sm:p-7 shadow-[0_12px_40px_-10px_rgba(16,185,129,0.5)] text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-emerald-50/80 font-medium mb-1 text-xs tracking-widest uppercase">资产总值</p>
            <h2 className="text-3xl sm:text-4xl leading-none font-extrabold tracking-tight break-words">
              ¥{totalValue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </h2>
            <div className="mt-5 flex gap-2">
              <span className="bg-white/15 text-xs font-medium px-3 py-1 rounded-full backdrop-blur-md">
                {assets.length} 项资产
              </span>
              <span className="bg-white/15 text-xs font-medium px-3 py-1 rounded-full backdrop-blur-md">
                {activeCount} 项使用中
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-10 text-center">
              ...
              <p className="text-slate-400 text-sm mb-6">点击右下角 + 添加第一项</p>
              <button
